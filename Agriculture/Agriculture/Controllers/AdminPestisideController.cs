...
{
    public class AdminPestisideController : Controller
    {
        ...
        // GET: AdminPestiside/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminPestiside/Create
